...
export default async function SkillsServer({ locale }: SkillsServerProps) {
  ...
  return (
    <>
      ...
      <div className="my-6 animate-jump-in">
        <p className="text-white text-3xl text-center my-4">{t("mobile")}</p>
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 justify-items-center mx-8 lg:mx-[20rem] gap-6">
          {renderSkillCards(mobile, "mobile")}
        </div>
      </div>
